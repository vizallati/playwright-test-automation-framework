...
@scenario('features/wp_crawler.feature', 'Trigger crawl')
def test_trigger_crawl():
    pass


@pytest.mark.case_id('WP-002')
@scenario('features/wp_crawler.feature', 'Check crawl results')
def test_check_crawl_results():
    pass


@pytest.mark.case_id('WP-003')
@scenario('features/wp_crawler.feature', 'Deletion of previous crawl results')
def test_check_crawl_results_deletion():
    pass


@pytest.mark.case_id('WP-004')
@scenario('features/wp_crawler.feature', 'Check deletion of sitemap file after crawl')
